...
const navLinkClassName = ({ isActive }: { isActive: boolean }) =>
  cn(
    "flex items-center gap-3 rounded-2xl px-4 py-3 text-sm font-medium transition-all duration-200 lg:px-3.5 lg:py-2.5",
    isActive
  ...
  return (
    <div className="min-h-screen lg:grid lg:grid-cols-[320px_1fr]">
      <aside className="relative overflow-hidden border-b border-white/5 bg-[linear-gradient(160deg,#1e1b4b_0%,#312e81_48%,#0f172a_100%)] px-5 py-5 text-white lg:sticky lg:top-0 lg:h-screen lg:border-b-0 lg:border-r lg:border-white/5 lg:px-6 lg:py-6">
        ...
        <div className="relative flex h-full min-h-0 flex-col gap-6 overflow-y-auto pr-1 lg:pr-2">
          <div className="space-y-6">
            <div className="rounded-[30px] border border-white/5 bg-white/5 p-4 backdrop-blur-xl shadow-xl shadow-indigo-950/20">
              <p className="text-xs font-bold uppercase tracking-[0.3em] text-indigo-200">Gestor JMU</p>
              <h1 className='mt-3 font-["IBM_Plex_Serif",Georgia,serif] text-[2rem] leading-[1.08] font-medium'>
                Centro de processos
