...
export function AdminOperationsPage() {
  ...
  if (loading) {
    return <LoadingState description="A consolidar runtime, contadores e incidentes recentes." title="Carregando operacoes" />;
  }
  ...
  return (
    <section className="grid gap-6">
      <PageHeader
        ...
        description="Monitoramento minimo da aplicacao, com visao do runtime e dos incidentes desde o ultimo start."
        eyebrow="Operacoes"
