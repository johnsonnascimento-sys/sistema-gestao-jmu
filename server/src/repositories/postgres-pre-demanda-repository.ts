...
const BASE_FROM = `
  ...
  left join lateral (
    select
      ...
      pessoa.rg as pessoa_principal_rg,
      pessoa.pai as pessoa_principal_pai,
      pessoa.mae as pessoa_principal_mae,
      pessoa.endereco as pessoa_principal_endereco,
...
const BASE_SELECT = `
  select
    ...
    pessoa_principal.pessoa_principal_rg,
    pessoa_principal.pessoa_principal_pai,
    pessoa_principal.pessoa_principal_mae,
    pessoa_principal.pessoa_principal_endereco,
  ...
  const pessoaPrincipal =
    row.pessoa_principal_id === null || row.pessoa_principal_id === undefined
      ...
      : {
          ...
          rg: row.pessoa_principal_rg ? String(row.pessoa_principal_rg) : null,
          pai: row.pessoa_principal_pai ? String(row.pessoa_principal_pai) : null,
          mae: row.pessoa_principal_mae ? String(row.pessoa_principal_mae) : null,
          endereco: row.pessoa_principal_endereco ? String(row.pessoa_principal_endereco) : null,
...
function mapDemandaInteressado(row: QueryResultRow): DemandaInteressado {
  return {
    interessado: {
      ...
      rg: row.interessado_rg ? String(row.interessado_rg) : null,
      pai: row.interessado_pai ? String(row.interessado_pai) : null,
      mae: row.interessado_mae ? String(row.interessado_mae) : null,
      endereco: row.interessado_endereco ? String(row.interessado_endereco) : null,
    ...
    const result = await queryable.query(
      `
        select
          ...
          interessado.rg as interessado_rg,
          interessado.pai as interessado_pai,
          interessado.mae as interessado_mae,
          interessado.endereco as interessado_endereco,
