...
// Prints the top-level keys of an action object (from GET /api/v1/actions?pageId=...).
// Useful to discover fields like executeOnLoad/runBehaviour names.
//
// Usage: node scripts/appsmith_dump_action_keys.js <actionName>
//
...
async function main() {
  ...
  if (!a) throw new Error(`Action not found: ${actionName}`);
