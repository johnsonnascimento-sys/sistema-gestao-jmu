...
// Publishes (deploys) the current unpublished app state to the published app.
//
// Usage:
//   node scripts/appsmith_publish_app.js
//
...
async function main() {
  ...
  if (!baseUrl || !email || !password) {
    throw new Error("Missing APPSMITH_URL/APPSMITH_EMAIL/APPSMITH_PASSWORD");
  }
  ...
  console.log(JSON.stringify({ ok: true, applicationId, published }, null, 2));
}
